...
class ConfigurationManagerTest extends AbstractTestCase {
	...
	public function usesEnvironmentSettingToInstanciateCorrectConcreteInstanceForFrontend() {
		$environmentServiceMock = $this->getMock('TYPO3\CMS\Extbase\Service\EnvironmentService', ['isEnvironmentInFrontendMode']);
	...
	public function setCurrentPageUidIgnoresFrontendConfigurationManager() {
		$mock = $this->getMock($this->createInstanceClassName(), ['initializeConcreteConfigurationManager']);
		$configurationManager = $this->getMock('TYPO3\\CMS\\Extbase\\Configuration\\FrontendConfigurationManager', ['setCurrentPageId']);
	...
	public function setCurrentPageUidUsesBackendConfigurationManager() {
		$mock = $this->getMock($this->createInstanceClassName(), ['initializeConcreteConfigurationManager']);
		$configurationManager = $this->getMock('FluidTYPO3\\Flux\\Configuration\\BackendConfigurationManager', ['setCurrentPageId']);
	...
	public function getCurrentPageUidIgnoresFrontendConfigurationManager() {
		$mock = $this->getMock($this->createInstanceClassName(), ['initializeConcreteConfigurationManager']);
		$configurationManager = $this->getMock('TYPO3\\CMS\\Extbase\\Configuration\\FrontendConfigurationManager', ['getCurrentPageId']);
	...
	public function getCurrentPageUidUsesBackendConfigurationManager() {
		$mock = $this->getMock($this->createInstanceClassName(), ['initializeConcreteConfigurationManager']);
		$configurationManager = $this->getMock('FluidTYPO3\\Flux\\Configuration\\BackendConfigurationManager', ['getCurrentPageId']);
