...
<flux:form.sheet name="somefields" label="somefields">
<flux:field.input name="input" label="input"transform=""  default="" />
<flux:field.select name="select" label="select"transform=""  default="" />
<flux:field.checkbox name="checkbox" label="checkbox"transform=""  default=""  clearable="1" />
</flux:form.sheet>
