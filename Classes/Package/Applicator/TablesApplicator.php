...
/**
 * Class TablesApplicator
 *
 * Applies runtime configuration normally contained in "ext_tables.php"
 * which is why the class is named thusly.
 */
class TablesApplicator extends AbstractApplicator {
