...
..  Source: fluidtypo3/flux/development/Field/CheckboxViewHelper.php

:edit-on-github-link: Field/CheckboxViewHelper.php
:navigation-title: field.checkbox
.. include:: /Includes.rst.txt

.. _fluidtypo3-flux-field-checkbox:
...
.. _fluidtypo3-flux-field-checkbox_source:

Source code
===========

Go to the source code of this ViewHelper: `CheckboxViewHelper.php (GitHub) <fluidtypo3/flux/development/Field/CheckboxViewHelper.php>`__.

.. _fluidtypo3-flux-field-checkbox_arguments:

Arguments
=========

The following arguments are available for `<flux:field.checkbox>`:

..  contents::
    :local:


.. _fluidtypo3-flux-field-checkbox-name_argument:

name
----

..  confval:: name
    :name: fluidtypo3-flux-field-checkbox-name
    :type: string
    :required: true

    Name of the attribute, FlexForm XML-valid tag name string

.. _fluidtypo3-flux-field-checkbox-label_argument:

label
-----

..  confval:: label
    :name: fluidtypo3-flux-field-checkbox-label
    :type: string
    :required: false
...
.. _fluidtypo3-flux-field-checkbox-default_argument:

default
-------

..  confval:: default
    :name: fluidtypo3-flux-field-checkbox-default
    :type: string
    :required: false

    Default value for this attribute

.. _fluidtypo3-flux-field-checkbox-native_argument:

native
------

..  confval:: native
    :name: fluidtypo3-flux-field-checkbox-native
    :type: boolean
    :required: false
...
.. _fluidtypo3-flux-field-checkbox-position_argument:

position
--------

..  confval:: position
    :name: fluidtypo3-flux-field-checkbox-position
    :type: string
    :required: false
...
.. _fluidtypo3-flux-field-checkbox-required_argument:

required
--------

..  confval:: required
    :name: fluidtypo3-flux-field-checkbox-required
    :type: boolean
    :required: false

    If TRUE, this attribute must be filled when editing the FCE

.. _fluidtypo3-flux-field-checkbox-exclude_argument:

exclude
-------

..  confval:: exclude
    :name: fluidtypo3-flux-field-checkbox-exclude
    :type: boolean
    :required: false

    If TRUE, this field becomes an "exclude field" (see TYPO3 documentation about this)

.. _fluidtypo3-flux-field-checkbox-transform_argument:

transform
---------

..  confval:: transform
    :name: fluidtypo3-flux-field-checkbox-transform
    :type: string
    :required: false
...
.. _fluidtypo3-flux-field-checkbox-enabled_argument:

enabled
-------

..  confval:: enabled
    :name: fluidtypo3-flux-field-checkbox-enabled
    :type: boolean
    :Default: true
    :required: false
...
.. _fluidtypo3-flux-field-checkbox-requestupdate_argument:

requestUpdate
-------------

..  confval:: requestUpdate
    :name: fluidtypo3-flux-field-checkbox-requestupdate
    :type: boolean
    :required: false

    If TRUE, the form is force-saved and reloaded when field value changes

.. _fluidtypo3-flux-field-checkbox-displaycond_argument:

displayCond
-----------

..  confval:: displayCond
    :name: fluidtypo3-flux-field-checkbox-displaycond
    :type: string
    :required: false
...
.. _fluidtypo3-flux-field-checkbox-inherit_argument:

inherit
-------

..  confval:: inherit
    :name: fluidtypo3-flux-field-checkbox-inherit
    :type: boolean
    :Default: true
    :required: false
...
.. _fluidtypo3-flux-field-checkbox-inheritempty_argument:

inheritEmpty
------------

..  confval:: inheritEmpty
    :name: fluidtypo3-flux-field-checkbox-inheritempty
    :type: boolean
    :Default: true
    :required: false
...
.. _fluidtypo3-flux-field-checkbox-clear_argument:

clear
-----

..  confval:: clear
    :name: fluidtypo3-flux-field-checkbox-clear
    :type: boolean
    :required: false

    If TRUE, a "clear value" checkbox is displayed next to the field which when checked, completely destroys the current field value all the way down to the stored XML value

.. _fluidtypo3-flux-field-checkbox-variables_argument:

variables
---------

..  confval:: variables
    :name: fluidtypo3-flux-field-checkbox-variables
    :type: mixed
    :Default: array ()
    :required: false
...
.. _fluidtypo3-flux-field-checkbox-extensionname_argument:

extensionName
-------------

..  confval:: extensionName
    :name: fluidtypo3-flux-field-checkbox-extensionname
    :type: string
    :required: false

    If provided, enables overriding the extension context for this and all child nodes. The extension name is otherwise automatically detected from rendering context.

.. _fluidtypo3-flux-field-checkbox-config_argument:

config
------

..  confval:: config
    :name: fluidtypo3-flux-field-checkbox-config
    :type: mixed
    :Default: array ()
    :required: false
